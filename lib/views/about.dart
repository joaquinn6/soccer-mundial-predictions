...
Si llegaste hasta aquí es porque ya te has registrado, podrás ver tus puntos acumulados en la tabla de posiciones, donde también podrás agregar a tus amigos por su nombre de usuario y ver quien conoce mejor a las selecciones que están disputando Qatar 2022.
                ...
                Align(
                  ...
                  child: TextButton.icon(
                    onPressed: () { _launchUrl('https://www.linkedin.com/in/joaquin-n6'); }, 
                    icon: FaIcon(FontAwesomeIcons.linkedin, color: Theme.of(context).primaryColor, size: 30,),
                    label: Text('Joaquín Núñez Vega', style: TextStyle( color: Theme.of(context).primaryColor),),
                  ),
                ),
                Align(
                  alignment: Alignment.topLeft,
                  child: TextButton.icon(
                    onPressed: () { _launchUrl('https://www.linkedin.com/in/marlon-jdu'); }, 
                    icon: FaIcon(FontAwesomeIcons.linkedin, color: Theme.of(context).primaryColor, size: 30,),
                    label: Text('Marlon José Dávila Urroz', style: TextStyle( color: Theme.of(context).primaryColor),),
                  ),
                ),
                Align(
                  alignment: Alignment.topLeft,
                  child: TextButton.icon(
                    onPressed: () { _launchUrl('https://www.linkedin.com/in/jonathan-ney21'); }, 
                    icon: FaIcon(FontAwesomeIcons.linkedin, color: Theme.of(context).primaryColor, size: 30,),
                    label: Text('Jonathan Tomás Ney Mayorga', style: TextStyle( color: Theme.of(context).primaryColor),),
                  ),
                ),
              ],
            ),
