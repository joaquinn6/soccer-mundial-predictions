...
class _UserPageState extends State<UserPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      child: Semantics(
        label: 'Inicio de sesión o registro',
        child: Scaffold(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text("Registro - Login",
                        style: Theme.of(context).textTheme.headline6),
                  ),
                  const Padding(
                    padding: EdgeInsets.all(10.0),
                    child: Text(
                      'Si no tiene una cuenta se creará una, si ya tiene una cuenta, escribe los mismos datos y se logueara',
